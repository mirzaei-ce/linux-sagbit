...
#ifndef SAGBIT_QT_SAGBITUNITS_H
#define SAGBIT_QT_SAGBITUNITS_H
...
/** Sagbit unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class SagbitUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit SagbitUnits(QObject *parent);

    /** Sagbit units.
      @note Source: https://en.sagbit.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        SBT,
...
typedef SagbitUnits::Unit SagbitUnit;

#endif // SAGBIT_QT_SAGBITUNITS_H
