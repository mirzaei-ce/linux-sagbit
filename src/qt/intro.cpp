...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/sagbit"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Sagbit Core"),
     ...
     * override -datadir in the sagbit.conf file in the default data directory
     * (to be consistent with sagbitd behavior)
     */
    if(dataDir != getDefaultDataDirectory())
