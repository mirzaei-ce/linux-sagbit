...
#ifndef SAGBIT_TEST_SCRIPTNUM10_H
#define SAGBIT_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Sagbit Core 0.10.0, for cross-comparison.
 */
public:
