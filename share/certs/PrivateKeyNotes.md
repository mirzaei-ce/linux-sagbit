...
unlocked to sign the Sagbit-Qt.app bundle.
...
allowing somebody to distribute a Sagbit-Qt.app or sagbit-qt-setup.exe with a valid
...
that the sagbit-qt.exe file inside the installer had not been tampered with.
