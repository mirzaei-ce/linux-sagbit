Sagbit Core version 0.9.4 is now available from:

  https://sagbit.org/bin/0.9.4/
...
this update is incompatible with the Sagbit system and could lead to consensus
forks.

Sagbit Core released binaries from https://sagbit.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~sagbit/+archive/ubuntu/sagbit
- A third-party or self-compiled Sagbit Core

upgrade to Sagbit Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
