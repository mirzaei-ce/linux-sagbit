Sagbit version 0.5.4 is now available for download at:
http://sourceforge.net/projects/sagbit/files/Sagbit/sagbit-0.5.4/
...
http://gitorious.org/sagbit/sagbitd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Sagbit-Qt notifications under Growl 1.3.
Increase required age of Sagbit-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxSagbit properly when installing Sagbit-Qt over it. (Windows)
