Sagbit-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/sagbit/files/Sagbit/sagbit-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Sagbit
...
New/changed settings (command-line or sagbit.conf file)
--------------------------------------------------------
